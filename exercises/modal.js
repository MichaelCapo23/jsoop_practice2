class Modal {
    ...
    constructor(shadowDomElement, modalBody, domElement) {
        this.domElements = {
            shadow: $(shadowDomElement),
            modal: $(modalBody),
    ...
    show() {
        this.domElements.modal.css("display", "block");
        this.domElements.shadow.css("display", "block");
    }
    ...
    hide() {
        this.domElements.shadow.css("display", "none");
        this.domElements.modal.css("display", "none");
    }

    //takes in a string that it then puts inside the text of the modal message element
    //returns nothing
    updateContents(stringInput) {
        this.domElements.domElement.text(stringInput);
    }
    ...
    init() {
        this.domElements.shadow.css("display", "none");
        this.domElements.modal.css("display", "none");
        this.domElements.shadow.off();
        this.domElements.shadow.click(this.onClose);
        this.domElements.shadow.click(this.hide);
    }
